...
check "Recovery and updater use canonical bridge owner" bash -c 'for f in RECOVERY/PATCH_FILEPROVIDER_COORDINATED_READ_V1_20260920.sh RECOVERY/REBUILD_SUPRA_FRANCE_CLEAN_V2_20260921.sh RECOVERY/SUPRA_AUTOBUILD_SELF_UPDATE_V1.sh RECOVERY/BOOTSTRAP_SUPRA_SELF_HEAL_V1_20260921.sh RECOVERY/RECOVER_EXISTING_SUPRA_CHANNEL_20260920.sh RECOVERY/RELOAD_PATCHED_DRIVE_CONSUMER_V1_20260920.sh RECOVERY/RESTART_EXISTING_BRIDGE_VIA_LAUNCHAGENT_20260920.sh; do grep -Fq "com.novaera.supra.bridge-watcher" "$f" || exit 1; done'
check "Recovery and updater exclude retired bridge owner" bash -c 'for f in RECOVERY/PATCH_FILEPROVIDER_COORDINATED_READ_V1_20260920.sh RECOVERY/REBUILD_SUPRA_FRANCE_CLEAN_V2_20260921.sh RECOVERY/SUPRA_AUTOBUILD_SELF_UPDATE_V1.sh RECOVERY/BOOTSTRAP_SUPRA_SELF_HEAL_V1_20260921.sh RECOVERY/RECOVER_EXISTING_SUPRA_CHANNEL_20260920.sh RECOVERY/RELOAD_PATCHED_DRIVE_CONSUMER_V1_20260920.sh RECOVERY/RESTART_EXISTING_BRIDGE_VIA_LAUNCHAGENT_20260920.sh; do ! grep -Fq "com.novaera.sol-github-bridge" "$f" || exit 1; done'
